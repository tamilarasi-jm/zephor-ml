cat > /home/ubuntu/zephor-ml/generate_embeddings.py << 'PYEOF'
import os
import numpy as np
import torch
...
clip_model = CLIPModel.from_pretrained("openai/clip-vit-b-32")
clip_processor = CLIPProcessor.from_pretrained("openai/clip-vit-b-32")
clip_model.eval()
print("CLIP loaded!")
